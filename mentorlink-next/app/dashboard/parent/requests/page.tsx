...
export default function ParentRequestsPage() {
  ...
  return <div className="mx-auto max-w-5xl" dir="rtl">
    ...
    <nav className="mt-6 flex gap-2 rounded-2xl border bg-white p-2" aria-label="סוג הבקשות">
      <button onClick={() => setView("meetings")} className={`flex-1 rounded-xl px-4 py-3 font-black ${view === "meetings" ? "bg-blue-700 text-white" : "text-slate-700 hover:bg-blue-50"}`}>בקשות פגישה ופגישות</button>
