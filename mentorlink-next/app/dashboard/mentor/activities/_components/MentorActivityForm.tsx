...
export function MentorActivityForm({ activityId, needsNewDate = false }: { activityId?: string; needsNewDate?: boolean }) {
  ...
  useEffect(() => {
    ...
    void supabase.auth.getSession().then(async ({ data, error }) => {
      ...
      const [subjectsResponse, capabilitiesResponse, activityResponse] = await Promise.all([
      ...
      if (!active) return;
      if (!subjectsResponse.ok || !capabilitiesResponse.ok || (activityResponse && !activityResponse.ok)) {
