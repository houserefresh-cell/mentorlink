...
const initialForm: FormState = {
  ...
  equipment: "", accessibilityOptions: [], accessibilityOther: "", cancellationPolicy: "", locationType: "", venueName: "", address: "",
