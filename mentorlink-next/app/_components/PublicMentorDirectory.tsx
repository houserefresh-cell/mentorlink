...
function MentorCard({ mentor, activities, onOpen, readOnly }: { mentor: PublicMentor; activities: MentorPublicActivity[]; onOpen: (mentor: PublicMentor, action: DirectoryAction, origin: HTMLButtonElement) => void; readOnly: boolean }) {
  ...
  return (
    <article className="flex h-full min-w-0 flex-col overflow-hidden rounded-3xl border border-cyan-200 bg-gradient-to-b from-white via-white to-cyan-50/60 p-5 shadow-[0_18px_40px_-26px_rgba(37,99,235,0.6)] transition duration-200 hover:-translate-y-1 hover:border-blue-300">
